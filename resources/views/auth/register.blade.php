                ...
                <div class="box-body">
                    <form method="POST" action="{{ route('almacenarUsuario') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input id="telefono" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="telefono" value="{{ old('telefono') }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input id="direccion" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="direccion" value="{{ old('direccion') }}" required>
